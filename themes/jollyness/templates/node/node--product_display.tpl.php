...
*/
?>
<?php $has_sidebar = count(block_list('right_sidebar')) > 0;  ?>
<div id="node-<?php print $node->nid; ?>" class="product-content <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    <div class='row'>
        ...
        <div class="shop-right col-lg-8 col-md-8 col-sm-12">
            ...
            <div class="product-details-wrap dexp_tab_wrapper">
                <ul class="nav nav-tabs" id="myTab">
                    <li class="active"><a data-toggle="tab" href="#Description"><?php print t('Description'); ?></a></li>
                    <li class="">
                        <a data-toggle="tab" href="#Reviews"><?php print t('Reviews'); ?> (<?php print $comment_count;?>)</a>
                    </li>
                </ul>
