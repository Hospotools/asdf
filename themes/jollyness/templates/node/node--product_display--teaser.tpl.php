...
<div id="node-<?php print $node->nid; ?>" class="grid cs-style-3 <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    ...
    <div class="media_element">
        <figure>
            ...
            $characters = field_get_items('node', $node, 'field_characteristics');
            if (!empty($characters)) {
            ...
            ?>
            <?php if (isset($content['product:field_product_images'][0])) {
            ...
            <figcaption>
                ...
                <a href="<?php print $node_url;?>" title="View details" class="zoom"><i class="fa fa-eye"></i></a>
