...
*/
?>
<div id="node-<?php print $node->nid; ?>" class="blog_wrap <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  <?php print render($title_prefix); ?>
  <?php print render($title_suffix); ?>
  <!-- Begin title blog region teaser mode!-->
  <div class="title">
      <div class="post_date">
          <?php $icon = field_get_items('node', $node, 'field_type');
            if($icon){
              $icon = $icon[0]['value'];
            }
          ?>
      ...
      <div class="post_meta">
          <span>
            ...
            <?php print format_date($created, 'custom', 'd M y', null, $node->language); ?>
          </span>
          ...
          <?php endif;?>
          <span><i class="fa fa-comment"></i> <?php print $comment_count;?> <?php print t('Comments'); ?></span>
      </div><!-- end post-meta -->
  </div>
  ...
  <a href="<?php print $node_url;?>" class="readmore btn btn-primary"><?php print t('Read more'); ?></a>
